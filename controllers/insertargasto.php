...
<head>
    ...
    <title>·:.:· ConrEcugA - Insercion de gasto ·:.:·</title>
         ...
         if( !empty($_POST) ){
             ...
             if( isset($_POST['fecha']) && isset($_POST['cantidad'])){
                 ...
                 if( empty($_POST['concepto']) )
                  $aErrores[] = "Hay que introducir una empresa";
                 else{ $aMensajes[] = "El nº de empresa es: [".$concepto."]"; }   
                 // Nombre:
            ...
            if( count($aErrores) > 0 ){
                ...
                echo "<h2>ERRORES ENCONTRADOS:</h2>";
                 ...
                 for( $contador=0; $contador < count($aErrores); $contador++ )
                     ...
                     try {
                        $stmt = $con->prepare("INSERT INTO gastos (usuario, concepto, fecha, qty, nota, img) VALUES (:usuario, :concepto, :fecha, :qty, :nota, :img)");
                        //INSERT INTO `gastos` (`id`, `usuario`, `concepto`, `fecha`, `qty`, `nota`, `img`) VALUES ('1', '2', '12', '2020-05-02', '12.52', 'asdasdasdasd', NULL) 
                    // Bind y execute:
